...
# PostgreSQL in production (Docker), SQLite for local dev
...
# Django 5.2: BigAutoField is now the default; set explicitly for clarity
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Hireflow API',
    'DESCRIPTION': 'Applicant Tracking System — REST API for managing jobs, candidates, and hiring pipelines.',
    'VERSION': '1.0.0',
